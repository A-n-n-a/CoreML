...
open class ROGoogleTranslate {
    ...
    public var apiKey = "AIzaSyDHKDYdpGEN7Q0pZXLepVO7RH3ceZahYmA"
    ...
    ///
    open func translate(params:ROGoogleTranslateParams, callback:@escaping (_ translatedText:String) -> (), errorHandler: ((NSError) -> Void)? = nil) {
